...
public class NetUtils {
    ...
    public static boolean isPreferredNetworkInterface(NetworkInterface networkInterface) {
        String preferredNetworkInterface = System.getProperty(Constant.PREFERRED_NETWORK_INTERFACE);
        return Objects.equals(networkInterface.getDisplayName(), preferredNetworkInterface);
    }

    static boolean ignoreInterfaceByConfig(String interfaceName) {
        String regex = System.getProperty(Constant.IGNORED_NETWORK_INTERFACE_REGEX);
